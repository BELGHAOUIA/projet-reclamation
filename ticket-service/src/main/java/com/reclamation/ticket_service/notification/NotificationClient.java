...
/**
 * Client HTTP pour l'envoi de notifications via le service de notification.
 * Les appels sont non-bloquants pour l'opération principale : toute erreur est loguée.
 */
@Slf4j
@Service
